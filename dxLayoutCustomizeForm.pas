...
{                                                                    }
{           Copyright (c) 2001-2015 Developer Express Inc.           }
{           ALL RIGHTS RESERVED                                      }
{                                                                    }
...
type
  TdxLayoutControlCustomizeForm = class(TdxLayoutControlCustomCustomizeForm)
    ...
    procedure tvVisibleItemsEdited(Sender: TObject; Node: TTreeNode;
      var S: String);
    procedure tvVisibleItemsMouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure tvVisibleItemsMouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure tvVisibleItemsMouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure tvVisibleItemsChange(Sender: TObject; Node: TTreeNode);
    procedure tvVisibleItemsChanging(Sender: TObject; Node: TTreeNode;
      var AllowChange: Boolean);
    procedure tvVisibleItemsContextPopup(Sender: TObject; MousePos: TPoint;
      var Handled: Boolean);
    procedure tvVisibleItemsCustomDrawItem(Sender: TCustomTreeView;
      Node: TTreeNode; State: TCustomDrawState; var DefaultDraw: Boolean);
    procedure tvVisibleItemsEditing(Sender: TObject; Node: TTreeNode;
...
begin
  ...
  begin
    ...
    acTreeViewItemRename.Enabled := ACanModify and (tvVisibleItems.Selected <> nil) and (tvVisibleItems.SelectionCount = 1) and
      ...
      not TdxCustomLayoutItemAccess(tvVisibleItems.Selected.Data).IsParentLocked;
...
begin
  if Node.Deleting then
    Exit;
  if (TObject(Node.Data) is TdxCustomLayoutGroup) and TdxCustomLayoutGroup(Node.Data).Hidden and
...
const
  LayoutDirectionMap: array [TdxLayoutDirection] of TdxLayoutDirection = (ldVertical, ldHorizontal, ldVertical);
